...
<head>
  ...
  <meta charset="utf-8" />
  <link href="table99.css" rel="stylesheet">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@300&family=Ubuntu:wght@700&display=swap" rel="stylesheet">
  <!-- 메뉴 폰트 위3줄-->
  <!--설명 폰트 아래3줄-->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    ...
    <table class="table1"> 
     ...
     <!-- <div id="sibal">
      ...
      while( $row = mysqli_fetch_assoc( $result ) ) {
        echo '<div class="sibal"><tr>
        <td rowspan="3" class="imageKAN"><img src="data:image;base64 ,'.base64_encode($row['file']).'" width="300" height="300px" /></td>
        <td  class="menuKAN"> '. $row[ 'name' ] . ' </td>
      </tr>
        <tr>
        <td class="describeKAN">'. $row[ 'menu' ] . '</td>
        </tr>
        <tr>
        <td class="priceKAN">₩'. $row[ 'price' ] . '</td>
        </tr>
        <tr>
        <td colspan="2" class="emptyKAN"> 여백 </td>
        </tr>
